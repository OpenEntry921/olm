...
const sourceImages = [
  ...
  "Ludwik-logo.png",
  "ludwik-eko-dishwasher-tablets-40pcs.png",
  "ludwik-eko-dishwasher-tablets-75pcs.png",
  "ludwik-eko-dishwasher-tablets-120pcs.png",
  "ludwik-eko-dishwasher-powder-1-2kg.png",
